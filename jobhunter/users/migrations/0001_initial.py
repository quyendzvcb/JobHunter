    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Quản trị viên'), ('RECRUITER', 'Nhà tuyển dụng'), ('APPLICANT', 'Ứng viên')], default='APPLICANT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('MALE', 'Nam'), ('FEMALE', 'Nữ'), ('ANOTHER', 'Khác')], default='', max_length=20)),
